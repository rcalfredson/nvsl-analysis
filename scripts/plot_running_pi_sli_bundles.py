...
from src.plotting.running_pi_sli_bundle_plotter import plot_running_pi_sli_bundles
...
def main():
    ...
    p.add_argument(
        "--bundles",
        required=True,
        help="Comma-separated list of running PI/SLI bundle .npz files.",
    )
    p.add_argument(
        "--labels",
        default=None,
    ...
    p.add_argument(
        ...
        help=(
            "Y-axis metric to plot against actual reward count. "
    ...
    p.add_argument(
        ...
        default=argparse.SUPPRESS,
        help=(
            "Restrict the plotted reward-count range to ticks reached by at "
