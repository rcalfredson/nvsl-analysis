...
from src.plotting.turnback_excursion_bin_sli_bundle_plotter import (
    plot_turnback_excursion_bin_sli_bundles,
)
...
def main():
    ...
    p.add_argument(
        "--bundles",
        required=True,
        help="Comma-separated list of turnback-excursion-bin .npz bundles.",
    )
    ...
    p.add_argument(
        ...
        help="Which outer-radius-bin metric to plot.",
    )
    p.add_argument(
        "--sli-extremes",
        default=None,
