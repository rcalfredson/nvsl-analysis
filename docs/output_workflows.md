...
# Also plot Control top 20% versus bottom 50% across all radius pairs
...
Control top 20% and bottom 50% SLI subsets within each 3/5, 8/10, and 13/15 mm
radius pair, using the subset bundles generated by the same run. Its title is
hidden by default; set
